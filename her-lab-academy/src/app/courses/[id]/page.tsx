...
export default function PublicCoursePage({ params }: { params: { id: string } }) {
  ...
  const courseMap: Record<string, {
    ...
    '5':  { title: 'Fashion Design',             category: 'Vocational',  icon: '🧵', duration: '16 weeks', color: 'bg-purple-50 text-purple-600', description: 'Design and sew garments from scratch. Covers pattern making, fabric selection, hand and machine sewing, and building a small fashion business.', modules: [{ id: 'm1', title: 'Design Principles & Sketching', resourceCount: 3 }, { id: 'm2', title: 'Pattern Making & Cutting', resourceCount: 4 }, { id: 'm3', title: 'Sewing & Finishing', resourceCount: 5 }, { id: 'm4', title: 'Fashion Business', resourceCount: 2 }] },
    '6':  { title: 'Regenerative Agriculture',   category: 'Agriculture', icon: '🌍', duration: '12 weeks', color: 'bg-green-50 text-green-600',   description: 'Sustainable farming practices that restore soil health, increase yields, and protect the environment. Covers composting, agroforestry, and water harvesting.', modules: [{ id: 'm1', title: 'Soil Health & Composting', resourceCount: 4 }, { id: 'm2', title: 'Water Harvesting', resourceCount: 3 }, { id: 'm3', title: 'Agroforestry Practices', resourceCount: 4 }] },
    '7':  { title: 'Core Agriculture',           category: 'Agriculture', icon: '🌱', duration: '12 weeks', color: 'bg-lime-50 text-lime-600',     description: 'Foundational crop and livestock farming skills. Covers planting, pest control, animal husbandry, and market-ready food production.', modules: [{ id: 'm1', title: 'Crop Production', resourceCount: 4 }, { id: 'm2', title: 'Pest & Disease Management', resourceCount: 3 }, { id: 'm3', title: 'Livestock Basics', resourceCount: 3 }] },
    '8':  { title: 'Reproductive Health',        category: 'Health',      icon: '🩺', duration: '6 weeks',  color: 'bg-red-50 text-red-500',       description: 'Essential reproductive health education covering family planning, maternal health, FGM awareness, and accessing healthcare services in rural Kenya.', modules: [{ id: 'm1', title: 'Reproductive Health Basics', resourceCount: 3 }, { id: 'm2', title: 'Maternal & Child Health', resourceCount: 4 }, { id: 'm3', title: 'Rights & Healthcare Access', resourceCount: 3 }] },
    '9':  { title: 'ICT',                        category: 'Technology',  icon: '💻', duration: '10 weeks', color: 'bg-blue-50 text-blue-600',     description: 'Intermediate computer skills including word processing, spreadsheets, internet use, email, and introduction to coding concepts.', modules: [{ id: 'm1', title: 'Computer Fundamentals', resourceCount: 3 }, { id: 'm2', title: 'Office Applications', resourceCount: 5 }, { id: 'm3', title: 'Internet & Email', resourceCount: 3 }, { id: 'm4', title: 'Intro to Coding', resourceCount: 3 }] },
    '10': { title: 'Basic Digital Literacy',     category: 'Technology',  icon: '📱', duration: '6 weeks',  color: 'bg-cyan-50 text-cyan-600',     description: 'First steps into the digital world. Learn to use a smartphone, browse the internet safely, use WhatsApp, and access online services like M-Pesa.', modules: [{ id: 'm1', title: 'Using a Smartphone', resourceCount: 3 }, { id: 'm2', title: 'Internet Safety', resourceCount: 3 }, { id: 'm3', title: 'Digital Financial Services', resourceCount: 3 }] },
    '11': { title: 'Entrepreneurship',           category: 'Business',    icon: '💼', duration: '8 weeks',  color: 'bg-amber-50 text-amber-600',   description: 'Start and grow a small business. Covers business planning, budgeting, marketing, record keeping, and accessing micro-finance in Kenya.', modules: [{ id: 'm1', title: 'Business Idea & Planning', resourceCount: 4 }, { id: 'm2', title: 'Finance & Budgeting', resourceCount: 3 }, { id: 'm3', title: 'Marketing & Sales', resourceCount: 3 }] },
    '12': { title: 'Beadwork',                   category: 'Vocational',  icon: '📿', duration: '8 weeks',  color: 'bg-rose-50 text-rose-500',     description: 'Traditional and contemporary Pokot beadwork. Learn bead selection, pattern design, necklace and bracelet making, and selling your crafts at market.', modules: [{ id: 'm1', title: 'Bead Types & Tools', resourceCount: 3 }, { id: 'm2', title: 'Pattern Design', resourceCount: 4 }, { id: 'm3', title: 'Jewellery Making & Finishing', resourceCount: 3 }, { id: 'm4', title: 'Selling Your Craft', resourceCount: 2 }] },
    '13': { title: 'Soap Making',                category: 'Vocational',  icon: '🧼', duration: '4 weeks',  color: 'bg-teal-50 text-teal-600',     description: 'Learn to produce quality handmade soaps using locally available materials. Covers cold process, hot process, packaging, and selling your products.', modules: [{ id: 'm1', title: 'Ingredients & Safety', resourceCount: 3 }, { id: 'm2', title: 'Soap Making Methods', resourceCount: 4 }, { id: 'm3', title: 'Packaging & Sales', resourceCount: 3 }] },
  };
